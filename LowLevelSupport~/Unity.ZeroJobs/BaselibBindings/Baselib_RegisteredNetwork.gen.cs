...
namespace Unity.Baselib.LowLevel
{
    internal static unsafe partial class Binding
    {
        ...
        /// <summary>Network buffer structure.</summary>
        /// <remarks>One buffer can contain multiple packets and endpoints.</remarks>
        ...
        /// <summary>------------------------------------------------------------------------------------------------</summary>
        /// <remarks>Network endpoints are platform defined representation (sockaddr_in-like) of network address (family, ip, port).</remarks>
        [StructLayout(LayoutKind.Sequential)]
        ...
        public struct Baselib_RegisteredNetwork_Request
        {
            ...
            /// <summary>for sending:     remote address to which the payload is sent (required for UDP)</summary>
            /// <remarks>for receiving:   address from which the data was sent (optional)</remarks>
            public Baselib_RegisteredNetwork_Endpoint remoteEndpoint;
            /// <summary>TODO: Not support yet. (We would also need to support this in Baselib_Socket first)</summary>
            /// <remarks>
            /// for sending:     unused
        ...
        /// <summary>------------------------------------------------------------------------------------------------</summary>
        /// <remarks>UDP connectionless socket.</remarks>
        [StructLayout(LayoutKind.Sequential)]
        ...
        /// <summary>
        /// Creates an UDP socket with internal request
        /// </summary>
        /// <remarks>
        /// &
        /// completion queues.
